...
# Mac Problems
alias fuckingwebcam="sudo killall AppleCameraAssistant;sudo killall VDCAssistant; echo 'Restarted camera assistant...'"
alias fuckingaudio="sudo pkill coreaudiod; echo 'Restarted coreaudiod...'"
